...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_BLUE = SET_TEXT_COLOR + "117m"; // sky-ish
    public static final String SET_TEXT_COLOR_CYAN       = SET_TEXT_COLOR + "51m";  // vivid cyan
    public static final String SET_TEXT_COLOR_STEEL_BLUE = SET_TEXT_COLOR + "67m";  // softer blue
